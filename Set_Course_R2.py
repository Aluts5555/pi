...
#        print(outputString)
        m_avg.append(heading)
#        mean_m_avg1 = mean(m_avg)
        if(len(m_avg)) > 54:
            m_avg.pop(0)
            mean_m_avg = mean(m_avg)
#            print("mean_m_avg1= " , mean_m_avg1, "mean_m_avg= ", mean_m_avg, "\r")
            Course_Error = Course_Desired - mean_m_avg
            print("Course_Error= " , Course_Error,"\r")
            if Course_Error > 15:
                jog_left()
            elif Course_Error < 15:
                jog_right()
            else:
                continue
        else:
